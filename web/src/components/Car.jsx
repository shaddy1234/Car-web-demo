        ...
        <div className='main'>
            ...
            <div className='one'>
                ...
                <div className='car-details'>
                    ...
                    <p>EN ROUTE TO THE PORT OF MOMBASA! EXPECTED TIME OF ARRIVAL MARCH, 2024.

                        Specs include a Multifunctional steering wheel, Head up display, memory seats with heating function, rear amrest, sunroof, leather seats, adaptive headlights, analogue instrument cluster, Premium surround sound system, dual zone climate controls, and traction control.</p>
                    <br />
                    <hr />
                    <div className='bottom'>
            ...
            <div className='one'>
                ...
                <div className='car-details'>
                    ...
                    <p>NEN ROUTE TO THE PORT OF MOMBASA! EXPECTED TIME OF ARRIVAL 16th MARCH, 2024.

                        Specs include a Quattro AWD setup, Powered heated, half leather seats, Multifunctional steering wheel, Bang & Olufsen premium surround sound system, dual zone climate controls, adaptive cruise control, Blindspot Monitoring Assist, and Lane keep assist.</p>
                    <br />
                    <hr />
                    <div className='bottom'>
